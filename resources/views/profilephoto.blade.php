...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Name & Photo Change</div>
                @if (session('photo'))
                    <span class="alert alert-info">{{session('photo')}}</span>
                @endif
                <div class="card-body">
                   <form method="POST"action="{{route('profilechange')}}"enctype="multipart/form-data">
                    @csrf
                      ...
                      <button type="submit"class="btn btn-info mt-2 text-white">Update</button>
                   </form>
                </div>
            </div>
        </div>
